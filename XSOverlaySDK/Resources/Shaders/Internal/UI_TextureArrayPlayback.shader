Shader "XSOverlay/UI/TextureArrayPlayback"
{
     Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert(appdata_t v)
            {
                ...
                OUT.uv.xy = float2(v.uv.x * aspectRatio, v.uv.y) * _Scale + _Offset;
                OUT.uv.z = lerp(0, _FrameCount, frac(_Time.y * _PlaybackSpeed));
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
                ...
                half4 animated = UNITY_SAMPLE_TEX2DARRAY(_TextureArray, float3(IN.uv.xy, IN.uv.z));
